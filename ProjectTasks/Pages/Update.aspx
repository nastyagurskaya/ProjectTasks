<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="ProjectTasks.Pages.Update" %>
...
<body>
      <div style="caption-side"><b>Update task number <% Response.Write(String.Format(@"{0}", ID));%></b></div>
   ...
   RunAt="Server" />
        ...
        <div>
            <label>StartDate:</label><asp:TextBox ID="StartDate" runat="server" >ox>
            </asp:TextBox>
        ...
        <div>
         ...
         <div>
            ...
            <select name="ExecutorID">
                <option <% Response.Write(String.Format(@"value='{0}'>{0}", curTask.Executor.Name)); %> </option>
                 <%
                     foreach (ProjectTasks.Executor ex in GetExecutors())
                     {
                         if(ex.Id!=curTask.Executor.Id)
        ...
        <div>
          <%--  <button name='insert' type="submit">Insert</button>--%>
              <asp:Button ID="update" runat="server" Text="Update"  
               OnClick="updateBtn_Click" Width="95px" /> 
